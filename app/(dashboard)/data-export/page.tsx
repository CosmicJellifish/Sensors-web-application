...
import { DownloadDataLink } from "./_components/download-data-link";
import { ExportFilterProvider } from "./_components/export-filter-provider";
  ...
  return (
    <div className="p-[24px]">
      <div className="flex w-full max-w-[1152px] flex-col gap-[16px]">
        ...
        {/* The form and the download link both read the filter from here, so a
            change reaches the link without waiting for this page to re-render. */}
        <ExportFilterProvider filter={filter}>
          <div className="grid grid-cols-12 items-start gap-[16px]">
            ...
            <section className="col-span-8 overflow-hidden border border-hairline bg-white shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]">
              ...
              <div className="flex justify-end border-t border-hairline bg-panel px-[16px] pt-[17px] pb-[16px]">
                <DownloadDataLink hasRows={total > 0} />
              </div>
            </section>
          </div>
